def read_grades(gradefile):
    ...
    Precondition: gradefile starts with a heade that contains no blank
    lines, then has a blank line and then lines containing a student number
    and a grades
    '''
    ...
    line = gradefile.readline()
    while line != '':
        # Now we have s string containing the into for a single student
...
def count_grade_ranges(grades):
    ...
    Return a list of int where each index indicates how many grades were in
    these ranges:
    0-9: index 0
    10-19: index 1
    20-29: index 2
